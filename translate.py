...
tf.app.flags.DEFINE_integer("iterations", int(2e4), "Iterations to train for.")
# Architecture
...
tf.app.flags.DEFINE_string("train_dir", os.path.normpath(
    "C:\Projects\Thesis\Implementation\human-motion-prediction-master\human-motion-prediction-master\src\experiments"), "Training directory.")

tf.app.flags.DEFINE_string("action","walking", "The action to train on. all means all the actions, all_periodic means walking, eating and smoking")
...
tf.app.flags.DEFINE_boolean("sample", True, "Set to True for sampling.")
tf.app.flags.DEFINE_boolean("use_cpu", False, "Whether to use the CPU")
tf.app.flags.DEFINE_integer("load", 20000, "Try to load a previous checkpoint.")
